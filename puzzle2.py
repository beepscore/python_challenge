...
class Puzzle2:
    ...
    def get_character_counts(self, a_string):
    ...
    def get_string_from_unique_chars(self, a_string):
        character_counts = self.get_character_counts(a_string)
        unique_chars = list(char for char, count in character_counts
                            if count == 1)
